<template>
  <div class="overview">
    ...
    <lh-card title="技术栈">
      <lh-link :textArrs="technologyStacks" />
      <lh-description
        title="生产环境依赖"
        :column="2"
    ...
    <lh-card title="项目结构">
      <div class="c-left">
        <lh-code-panel language="bash" :code="projectDir" />
      </div>
    </lh-card>
...
import LhLink from '@/base-ui/link'
import LhDescription from '@/base-ui/description'
import LhCodePanel from '@/base-ui/codePanel'
